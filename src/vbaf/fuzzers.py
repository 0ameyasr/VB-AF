...
class VBAF:
    ...
    Attributes:
        payload (str): The core target string to embed.
    ...
    def generate_fuzzy_payload(self) -> str:
        ...
        fuzzy_payload: str = self.join_on.join(
            [
                (
                    ...
                    if k != argK
                    else f"{self.separator}{self.payload}{self.separator}"  # Payload is injected exactly at argK
                )
    ...
    def fuzz(
        ...
        **kwargs: Any,
        ...
        ```python
            ...
            fuzzer = VBAF("my payload here", tokens, n_size=15, rand_bounds=(2,5))
            ...
            for fuzzy_payload, result in fuzzing_harness("This is a mocked payload."):
        ...
        def decorator(inference: Callable) -> Callable:
            ...
            def wrapper(request: str, *args, **wrapper_kwargs) -> Generator:
                for _ in range(n_attempts):
                    fuzzer_kwargs = {
                        key: value
                        for key, value in kwargs.items()
                        if key in fuzzer_params
                    }
                    fuzzy_payload = self.generate_fuzzy_payload()
